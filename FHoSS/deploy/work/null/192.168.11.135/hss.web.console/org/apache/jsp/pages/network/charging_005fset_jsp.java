...
public final class charging_005fset_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title> Charging Info Sets </title>\n");
	...
	int id = Integer.parseInt(request.getParameter("id"));
      ...
      out.write("\tswitch(a){\n");
      out.write("\t\tcase 1:\n");
      out.write("\t\t\tdocument.CS_Form.nextAction.value=\"save\";\n");
      out.write("\t\t\tdocument.CS_Form.submit();\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t\tcase 2:\n");
      out.write("\t\t\tdocument.CS_Form.nextAction.value=\"reset\";\n");
      out.write("\t\t\tdocument.CS_Form.reset();\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t\tcase 3:\n");
      out.write("\t\t\tdocument.CS_Form.nextAction.value=\"refresh\";\n");
      out.write("\t\t\tdocument.CS_Form.submit();\t\t\t\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t\tcase 4:\n");
      out.write("\t\t\tdocument.CS_Form.nextAction.value=\"delete\";\n");
      out.write("\t\t\tdocument.CS_Form.submit();\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t}\n");
      out.write("}\n");
      ...
      out.write("\t\t\t<h1>Charging Info Sets</h1> \t\t\t\n");
      out.write("\t\t\t<br/><br/>\t\t\t\n");
      out.write("\t\t</td>\n");
      out.write("\t<tr>\t\n");
      ...
      _jspx_th_html_form_0.setAction("/CS_Submit");
      ...
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t<tr>\n");
          out.write("\t\t\t\t<td>\n");
          out.write("\t\t\t \t\t<table id=\"chg-table\" border=\"0\" align=\"center\" width=\"400\" >\t\t\t\t\t\t\n");
          out.write("\t\t\t \t\t<tr>\n");
          out.write("\t\t\t \t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t \t\t<table id=\"fields-table\" border=\"0\" cellspacing=\"1\" align=\"center\" width=\"100%\" style=\"border:2px solid #FF6600;\">\t\t\t\t\t\t\n");
  ...
  private boolean _jspx_meth_html_text_2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_2.setProperty("pri_ccf");
  ...
  private boolean _jspx_meth_html_text_3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_3.setProperty("sec_ccf");
  ...
  private boolean _jspx_meth_html_text_4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_4.setProperty("pri_ecf");
  ...
  private boolean _jspx_meth_html_text_5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_5.setProperty("sec_ecf");
    _jspx_th_html_text_5.setStyleClass("inputtext");
    _jspx_th_html_text_5.setStyle("width:200px;");
