...
public final class preferred_005fscscf_005fset_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<head>\n");
      java.util.List scscf_list = null;
      synchronized (request) {
        scscf_list = (java.util.List) _jspx_page_context.getAttribute("scscf_list", PageContext.REQUEST_SCOPE);
        if (scscf_list == null){
          throw new java.lang.InstantiationException("bean scscf_list not found within scope");
        }
      }
      out.write("\n");
      out.write("\n");
      out.write("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=ISO-8859-1\">\n");
      out.write("<title> Preferred S-CSCF Set </title>\n");
	...
	int id_set = Integer.parseInt(request.getParameter("id_set"));
      ...
      out.write("\t\tcase 1:\n");
      out.write("\t\t\tdocument.PrefS_Form.nextAction.value=\"save\";\n");
      out.write("\t\t\tdocument.PrefS_Form.submit();\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t\tcase 2:\n");
      out.write("\t\t\tdocument.PrefS_Form.nextAction.value=\"reset\";\n");
      out.write("\t\t\tdocument.PrefS_Form.reset();\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t\tcase 3:\n");
      out.write("\t\t\tdocument.PrefS_Form.nextAction.value=\"refresh\";\n");
      out.write("\t\t\tdocument.PrefS_Form.submit();\t\t\t\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t\tcase 4:\n");
      out.write("\t\t\tdocument.PrefS_Form.nextAction.value=\"delete\";\n");
      out.write("\t\t\tdocument.PrefS_Form.submit();\t\t\t\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t\tcase 5:\n");
      out.write("\t\t\tdocument.PrefS_Form.nextAction.value=\"delete_scscf\";\n");
      out.write("\t\t\tdocument.PrefS_Form.associated_ID.value = associated_ID;\n");
      out.write("\t\t\tdocument.PrefS_Form.submit();\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t\t\t\t\n");
      out.write("\t\tcase 12:\n");
      out.write("\t\t\tdocument.PrefS_Form.nextAction.value=\"add_scscf\";\n");
      out.write("\t\t\tdocument.PrefS_Form.submit();\n");
      out.write("\t\t\tbreak;\n");
      out.write("\t}\n");
      out.write("}\n");
      ...
      out.write("\t\t\t<h1>  Preferred S-CSCF Set </h1> \t\t\t\n");
      out.write("\t\t\t<br/><br/>\t\t\t\n");
      out.write("\t\t</td>\n");
      out.write("\t<tr>\t\n");
      ...
      _jspx_th_html_form_0.setAction("/PrefS_Submit");
      ...
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t<tr>\n");
          out.write("\t\t\t<td>\n");
          out.write("\t \t\t\t<table id=\"pcscf-table\" border=\"0\" align=\"center\" width=\"400\" >\t\t\t\t\t\t\n");
          out.write("\t \t\t\t<tr>\n");
          out.write(" \t\t\t\t\t<td>\n");
          ...
          out.write("\t\t\t\t<td>\t\n");
          out.write("\t\t\t\t\t<br />\n");
          out.write("\t\t\t\t\t<h2> Add S-CSCF </h2>\n");
          out.write("\t\t\t\t\t<table id=\"add-scscf-table\" width=\"600\" class=\"as\" border=\"0\" cellspacing=\"1\" align=\"center\" style=\"border:2px solid #FF6600;\">\n");
          out.write("\t\t\t\t\t<tr class=\"even\">\n");
          out.write("\t\t\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t\tS-CSCF Name\n");
          out.write("\t\t\t\t\t\t</td>\t\n");
          out.write("\t\t\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t\t");
          ...
          out.write("\t\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\t</tr>\t\n");
          out.write("\t\t\t\t\t</table> <!-- add-scscf-table-->\n");
          out.write("\t\t\t\t</td>\n");
          out.write("\t\t\t</tr>\n");
          out.write("\t\t\t");
          ...
          out.write("\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t<br />\t\t\t\t\t\t\n");
          out.write("\t\t\t\t\t<h2> List of attached S-CSCFs </h2>\n");
          out.write("\t\t\t\t\t<table id=\"list-attached-scscf\" class=\"as\" border=\"0\" cellspacing=\"1\" align=\"center\" width=\"600\" style=\"border:2px solid #FF6600;\">\n");
          out.write("\t\t\t\t\t<tr class=\"header\">\n");
          out.write("\t\t\t\t\t\t<td class=\"header\"> S-CSCF Name </td>\n");
          ...
          out.write("\t\t\t\t\t\t\t\t<td>  \n");
          out.write("\t\t\t\t\t\t\t\t\t");
          out.print( preferred_scscf_set.getScscf_name() );
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t</td>\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t<td>  \n");
          out.write("\t\t\t\t\t\t\t\t\t");
          out.print(preferred_scscf_set.getPriority());
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\t\t\t\t\n");
          out.write("\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"button\" name=\"delete_scscf\" \"value=\"Delete\" onclick=\"add_action_for_form(5, ");
          out.print( preferred_scscf_set.getId() );
          out.write(");\" disabled/>\t\n");
          out.write("\t\t\t\t\t\t\t\t\t");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t</table> <!-- list-attached-scscf -->\n");
          out.write("\t\t\t\t</td>\t\n");
          out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_text_2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_text_2 = (org.apache.struts.taglib.html.TextTag) _jspx_tagPool_html_text_value_styleClass_style_property_nobody.get(org.apache.struts.taglib.html.TextTag.class);
    ...
    if (_jspx_th_html_text_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_text_value_styleClass_style_property_nobody.reuse(_jspx_th_html_text_2);
    return false;
  }
  ...
  private boolean _jspx_meth_html_button_1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_button_1.setOnclick("add_action_for_form(3);");
  ...
  private boolean _jspx_meth_html_button_2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_button_2.setOnclick("add_action_for_form(2);");
  ...
  private boolean _jspx_meth_html_text_4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_text_4 = (org.apache.struts.taglib.html.TextTag) _jspx_tagPool_html_text_value_styleClass_style_property_nobody.get(org.apache.struts.taglib.html.TextTag.class);
    ...
    _jspx_th_html_text_4.setProperty("scscf_name");
    ...
    if (_jspx_th_html_text_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_text_value_styleClass_style_property_nobody.reuse(_jspx_th_html_text_4);
    return false;
  }
  ...
  private boolean _jspx_meth_html_text_5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_5.setProperty("priority");
  ...
  private boolean _jspx_meth_html_button_4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_button_4.setProperty("scscf_add_button");
