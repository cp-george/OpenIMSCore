...
public final class as_005fsearch_005fresult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tdocument.AS_SearchForm.crtPage.value = pageId;\n");
      out.write("\tdocument.AS_SearchForm.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function rowsPerPageChanged(){\n");
      out.write("\tdocument.AS_SearchForm.crtPage.value = 1;\n");
      out.write("\tdocument.AS_SearchForm.submit();\n");
      out.write("}\n");
      out.write("</script> \n");
      out.write("</head>\n");
      ...
      out.write("\t\t\t<h1> Application Server - Search Results </h1> \n");
      out.write("\t\t\t<br/><br/>\t\t\n");
      out.write("\t\t</td>\n");
      out.write("\t</tr>\n");
      ...
      out.write("\t<tr>\n");
      out.write("\t\t<td>\n");
      out.write("\t \t\t<table id=\"result-table\" class=\"as\" border=\"0\" cellspacing=\"1\" align=\"center\" style=\"border:2px solid #FF6600;\" width=\"400\">\t\n");
      out.write("\t\t\t\t<tr class=\"header\">\n");
      out.write("\t\t\t\t\t<td class=\"header\" width=\"50\"> ID </td>\n");
      out.write("\t\t\t\t\t<td class=\"header\"> Name </td>\n");
      out.write("\t\t\t\t\t<td class=\"header\"> Server Name </td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\t");
				...
				if (resultList != null && resultList.size() > 0){
					...
					while (it.hasNext()){
						app_srv = (ApplicationServer) it.next();
      ...
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t");
      out.print( app_srv.getId() );
      out.write("\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t<td> \n");
      out.write("\t\t\t\t\t\t\t<a href=\"/hss.web.console/AS_Load.do?id=");
      out.print( app_srv.getId() );
      out.write("\"> \n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print( app_srv.getName() );
      out.write("\n");
      out.write("\t\t\t\t\t\t\t</a>\t\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t");
      out.print( app_srv.getServer_name() );
      out.write("\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</tr>\n");
      ...
      _jspx_th_html_form_0.setAction("/AS_Search");
