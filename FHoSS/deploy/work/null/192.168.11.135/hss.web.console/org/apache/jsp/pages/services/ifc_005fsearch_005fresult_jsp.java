...
public final class ifc_005fsearch_005fresult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tdocument.IFC_SearchForm.crtPage.value = pageId;\n");
      out.write("\tdocument.IFC_SearchForm.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function rowsPerPageChanged(){\n");
      out.write("\tdocument.IFC_SearchForm.crtPage.value = 1;\n");
      out.write("\tdocument.IFC_SearchForm.submit();\n");
      out.write("}\n");
      out.write("</script> \n");
      out.write("</head>\n");
      ...
      out.write("\t\t\t<h1> Initial Filter Criteria - Search Results </h1> \n");
      out.write("\t\t\t<br/><br/>\t\t\n");
      out.write("\t\t</td>\n");
      out.write("\t</tr>\n");
      ...
      out.write("\t\t\t\t\t<td class=\"header\"> Triggering Point Id </td>\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<td class=\"header\"> Application Server Id</td>\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<td class=\"header\"> Profile Part Indicator </td>\t\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\t");
