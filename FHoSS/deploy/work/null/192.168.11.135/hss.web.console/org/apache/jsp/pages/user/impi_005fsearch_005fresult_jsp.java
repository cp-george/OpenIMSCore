...
public final class impi_005fsearch_005fresult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tdocument.IMPI_SearchForm.crtPage.value = pageId;\n");
      out.write("\tdocument.IMPI_SearchForm.submit();\n");
      out.write("}\n");
      out.write("\n");
      out.write("function rowsPerPageChanged(){\n");
      out.write("\tdocument.IMPI_SearchForm.crtPage.value = 1;\n");
      out.write("\tdocument.IMPI_SearchForm.submit();\n");
      out.write("}\n");
      out.write("</script> \n");
      out.write("</head>\n");
      ...
      out.write("\t\t\t<h1> Private User Identity - Search Results </h1> \n");
      out.write("\t\t\t<br/><br/>\t\t\n");
      out.write("\t\t</td>\n");
      out.write("\t</tr>\n");
      out.write("\t</table>\n");
      ...
      out.write("\t<tr>\n");
      out.write("\t\t<td>\n");
      out.write("\t \t\t<table  id=\"result-table\" class=\"as\" border=\"0\" cellspacing=\"1\" align=\"center\" width=\"600\" style=\"border:2px solid #FF6600;\">\t\n");
      out.write("\t\t\t\t<tr class=\"header\">\n");
      out.write("\t\t\t\t\t<td class=\"header\"> ID </td>\n");
      out.write("\t\t\t\t\t<td class=\"header\"> Identity </td>\n");
      out.write("\t\t\t\t\t<td class=\"header\"> Auth. Scheme</td>\n");
      out.write("\t\t\t\t\t<td class=\"header\"> SQN </td>\t\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\n");
      out.write("\t\t\t\t");
      ...
      out.write("\"> \n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print( impi.getIdentity() );
      out.write("\n");
      out.write("\t\t\t\t\t\t\t</a>\t\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t");
      out.print( impi.getAuth_scheme() );
      out.write("\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t");
      out.print( impi.getSqn() );
      out.write("\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t");
      ...
      _jspx_th_html_form_0.setAction("/IMPI_Search");
